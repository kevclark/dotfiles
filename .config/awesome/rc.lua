...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            --weather_widget({
            --api_key='2fd2e8102f3aa23b90ecaf6ab90c959e',
            --coordinates = {51.995930, -2.137730},
...
globalkeys = gears.table.join(
   ...
   -- Media Keys
    ...
    -- Lock screen
    awful.key({ modkey, "Control"  }, "l", function () awful.spawn("gnomelock-gnome-screensaver") end,
    ...
    awful.key({ modkey }, "x",
        function()
            logout_popup.launch {
                onlock = function () awful.spawn("gnomelock-gnome-screensaver") end
            }
        end,
